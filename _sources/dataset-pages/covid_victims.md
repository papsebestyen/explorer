...
```{image} ../datasets/covid_victims/intro/assets/out-8.png
...
```{include} ../datasets/covid_victims/intro/assets/out-10.html
```
:::
...
```{div} col-5
 <a href="file:///tmp/tmpd8_q43x5/covid_victims/covid_victim.csv">{badge}`Download CSV,badge-primary`</a>
```

```{div} col-3
 <a href="file:///tmp/tmpd8_q43x5/covid_victims/covid_victim-profile.html">{badge}`Open Table Profile,badge-success`</a>
```
